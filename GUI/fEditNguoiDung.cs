...
namespace GUI
{
    public partial class fEditNguoiDung : Form
    {
        ...
        {
            var res = MessageBox.Show("Are you sure you want to reset the password?", "Reset the password", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
        ...
        private void labelNhomNND_Click(object sender, EventArgs e)
        {
