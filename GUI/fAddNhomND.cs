...
namespace GUI
{
    public partial class fAddNhomND : Form
    {
        ...
        private void butSave_Click(object sender, EventArgs e)
        {
            ...
            if(ten == "")
            {
                MessageBox.Show("Fail", "Erro", MessageBoxButtons.OK, MessageBoxIcon.Error);
                return;
            }    
            ...
            if (res == "") MessageBox.Show("Success!", "Notification", MessageBoxButtons.OK, MessageBoxIcon.Information);
